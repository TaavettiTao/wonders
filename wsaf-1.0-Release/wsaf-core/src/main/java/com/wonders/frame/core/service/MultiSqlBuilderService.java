...
public final static String logicDelField="removed";
	...
	//定义关联子查询的json模板
	public final static String relatedSubQueryJsonFormat="{\"select\":{\"all\":\"%s.*\",\"fid\":\"relation.%s\"},\"from\":{\"%s\":\"%s\",\"relation\":\"relation\"},\"where\":{\"relation.%s\":\"%s.id\",\"relation.ptype\":\"%s\",\"relation.ntype\":\"%s\",\"relation.ruleTypeId\":\"%s\"}}";
