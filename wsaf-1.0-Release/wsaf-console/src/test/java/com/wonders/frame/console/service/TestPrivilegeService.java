...
public class TestPrivilegeService extends AbstractTransactionalJUnit4SpringContextTests {
	...
	@Test
	public void testBindPrivilegeType(){
		//获取permissions数据
		String type = "user";
		Integer id = 241;
		...
		for (Permission permission : permissions) {
			...
			assertNull(permission.getPrivilegeType());
		}
