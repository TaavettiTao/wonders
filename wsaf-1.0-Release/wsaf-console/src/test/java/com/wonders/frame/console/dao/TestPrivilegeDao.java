...
public class TestPrivilegeDao extends AbstractTestDao<Privilege>{
	private  Logger logger = LoggerFactory.getLogger(this.getClass());
	@Resource
	public PrivilegeDao dao;
	...
	public void findByName(){
		Privilege rec=dao.findByName(getFirstRec().getName());
	...
	@Override
	public Privilege buildRec(String index) {
		return new Privilege("测试name"+index, "测试type"+index, "测试description"+index,0);
	}

	@Override
	public void modifyRec(Privilege rec) {
		rec.setName("测试修改");
