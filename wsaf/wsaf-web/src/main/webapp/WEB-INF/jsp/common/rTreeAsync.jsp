...
// 		       commonTable(ruleTypeId,pmodname,rule);
			  ...
			  _strTable+= "<input type=\"button\" value=\"加载树\" onclick=\"onloadZTree_async('treeDemo','"+ruleTypeId+"','"+pmodname+"','"+pmodname+"',false,false);\"></input>";
			...
			<div class="v-main">
				...
				<div id="pveast">
					...
					<div id="veast">
						...
						<!-- 									<li class="title">&nbsp;&nbsp;父模块: <input id="pType" -->
						<!-- 										type="text" readonly value="" style="width: 120px;" /></li> -->

						<!-- 									<li class="title">&nbsp;&nbsp;用户: <input id="user" -->
						<!-- 										type="text" readonly value="" style="width: 120px;" -->
						<!-- 										onclick="showMenu('user');" /> &nbsp;<a id="menuBtn" href="#" -->
						<!-- 										onclick="showMenu(); return false;">select</a></li> -->
						<!-- 									<li class="title">&nbsp;&nbsp;角色: <input id="role" -->
						<!-- 										type="text" readonly value="" style="width: 120px;" -->
						<!-- 										onclick="showMenu('role');" /> &nbsp;<a id="menuBtn" href="#" -->
						<!-- 										onclick="showMenu(); return false;">select</a></li> -->
						<!-- 									<li class="title">&nbsp;&nbsp;组织机构: <input id="organ" -->
						<!-- 										type="text" readonly value="" style="width: 120px;" -->
						<!-- 										onclick="showMenu('organ');" /> &nbsp;<a id="menuBtn" -->
						<!-- 										href="#" onclick="showMenu(); return false;">select</a></li> -->
						...
						<!-- 										<ul class="list"> -->
						<!-- 											<li class="title">&nbsp;&nbsp;组织: <input -->
						<!-- 												id="organ_organ" type="text" readonly value="" -->
						<!-- 												style="width: 120px;" -->
						<!-- 												onclick="showRelationMenu('organ','organ','tree_relation',true);" />&nbsp; -->
						<!-- 											</li> -->
						<!-- 											<li class="title">&nbsp;&nbsp;用户: <input id="organ_user" -->
						<!-- 												type="text" readonly value="" style="width: 120px;" -->
						<!-- 												onclick="showRelationMenu('organ','user','tree_relation',true);" />&nbsp; -->
						<!-- 											</li> -->
						<!-- 											<li class="title">&nbsp;&nbsp;角色: <input id="organ_role" -->
						<!-- 												type="text" readonly value="" style="width: 120px;" -->
						<!-- 												onclick="showRelationMenu('organ','role','tree_relation',true);" />&nbsp; -->
						<!-- 											</li> -->
						<!-- 										</ul></li> -->
						<!-- 								</ul> -->
						<!-- 							</div> -->
						...
						<!-- 							<ul id="tree_obj" class="ztree" -->
						<!-- 								style="margin-top: 0; width: 220px; height: 300px;"></ul> -->
						<!-- 						</div> -->
						<!-- 						<div id="menuContent_relation" class="menuContent" -->
						<!-- 							style="display: none; position: absolute;"> -->
						<!-- 							<ul id="tree_relation" class="ztree" -->
						<!-- 								style="margin-top: 0; width: 220px; height: 300px;"></ul> -->
						<!-- 						</div> -->
					</div>
				</div>
