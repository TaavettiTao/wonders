...
public class TestMultiDao extends AbstractTransactionalJUnit4SpringContextTests {
	...
	public void initData(){
		String sql="select a.id id_0, a.name name_1,b.id id_2,b.p_type ptype_3,b.p_id pid_4,b.n_type ntype_5,b.n_id nid_6 from af_rule_type a,af_relation b where a.id=b.rule_type_id and a.name=? and b.p_type=?";
		...
		se=new MultiQuerySqlElement(sql,fieldList,paramList);
	}
