...
@Entity
@Table(name = "AF_CODES")
public class Codes implements IDefaultModel{
	...
	public Codes(Integer ccateId, String pcode, String code,
			String display, String description, Integer orders,Integer removed) {
