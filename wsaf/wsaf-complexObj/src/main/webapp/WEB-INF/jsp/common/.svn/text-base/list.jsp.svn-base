...
// 	        $.ajax({
// 				type: 'POST',
<%-- 				url: '<%=basePath%>objInfo/api/findAll', --%>
// 				dataType:'json',
// 				cache : false,
			...
			<table border="0">
				...
				<tr>
					...
					<td>
						...
						<a href="basicCrud/${entity.name}/toUpload/${rec.id}" title="上传附件"><img src="images/icons2/pencil_16.png"/></a>
					</td>
				...
				<tfoot>
					...
					<input class="button" type="button" value="测试Ajax" onclick="ajaxTest();" />
